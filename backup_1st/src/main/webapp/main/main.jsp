            ...
            <div class="rd-navbar-inner-outer">
              <div class="rd-navbar-inner">
                ...
                <div class="menu-search">
                	<div class="rd-nav-item"><a class="rd-nav-link" href="#" style="font-size:18px">공지사항</a></div>
                	...
                	<div class="rd-nav-item"><a class="rd-nav-link" href="#">로그인</a></div>
                	<div class="rd-nav-item"><a class="rd-nav-link" href="#">마이페이지</a></div>
                </div>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-sm-9 col-md-8 col-lg-7 col-xl-7 offset-lg-1 offset-xxl-0">
                    ...
                    <p class="big swiper-text" data-caption-animate="fadeInLeft" data-caption-delay="300">당신의 여름이 특별해집니다</p><a class="button button-lg button-primary button-winona button-shadow-2" href="#" data-caption-animate="fadeInUp" data-caption-delay="300">View our menu</a>
                  </div>
                </div>
              </div>
            </div>
